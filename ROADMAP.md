...
Plans:
- [x] 05-01-PLAN.md — Schema v3, analytics package, deterministic seeder, matplotlib pin
- [x] 05-02-PLAN.md — performance.py: Brier, calibration, P&L, Sharpe, daily_pnl aggregator
- [x] 05-03-PLAN.md — Feature importance tracking and edge decay analysis
- [x] 05-04-PLAN.md — Shadow recalibration and the evaluator performance snapshot
- [x] 05-05-PLAN.md — Daily report CLI, reliability diagram, phase e2e test
